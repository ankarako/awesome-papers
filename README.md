...
[Latent Avatar: Learning Latent Expression Code for Expressive Neural Head Avatar, SIGGRAPH](https://arxiv.org/pdf/2305.01190.pdf), _[Project Page](https://www.liuyebin.com/latentavatar/)_, _[Code](https://github.com/YuelangX/LatentAvatar)_
...
[NeuFace: Realistic 3D Neural Face Rendering from Multi-view Images, CVPR](https://openaccess.thecvf.com/content/CVPR2023/papers/Zheng_NeuFace_Realistic_3D_Neural_Face_Rendering_From_Multi-View_Images_CVPR_2023_paper.pdf), _[Code](https://github.com/aejion/NeuFace)_


[Human 3D Avatar Modeling with Implicit Neural Representation: A Brief Survey, ICSPS](https://arxiv.org/pdf/2306.03576.pdf)

[Deformable Model-Driven Neural Rendering for High-Fidelity 3D Reconstruction of Human Heads Under Low-View Settings](https://arxiv.org/pdf/2303.13855.pdf), _[Code](https://github.com/xubaixinxbx/3dheads)_


[NeRSemble: Multi-view Radiance Field Reconstruction of Human Heads, SIGGRAPH](https://arxiv.org/pdf/2305.03027.pdf), _[Project Page](https://tobias-kirschstein.github.io/nersemble/)_, _[Code](https://github.com/tobias-kirschstein/nersemble)_
...
[Implicit Neural Deformation for Sparse-View Face Reconstruction, Computer Graphics Forum](https://arxiv.org/pdf/2112.02494.pdf), 


[ImFace: A Nonlinear 3D Morphable Face Model with Implicit Neural Representations, CVPR](https://arxiv.org/pdf/2203.14510.pdf), _[Code](https://github.com/MingwuZheng/ImFace)_
...
[SAOR: Single-View Articulated Object Reconstruction](https://mehmetaygun.github.io/saor_files/saor.pdf), _[Project Page](https://mehmetaygun.github.io/saor)_


[InstantAvatar: Learning Avatars form Monocular Video in 60 seconds, CVPR](https://openaccess.thecvf.com/content/CVPR2023/papers/Jiang_InstantAvatar_Learning_Avatars_From_Monocular_Video_in_60_Seconds_CVPR_2023_paper.pdf), _[Project Page](https://tijiang13.github.io/InstantAvatar/)_, _[Code](https://github.com/tijiang13/InstantAvatar)_

[Vid2Avatar: 3D Avatar Reconstruction from Videos in the Wild via Self-supervised Scene Decomposition, CVPR](https://openaccess.thecvf.com/content/CVPR2023/papers/Guo_Vid2Avatar_3D_Avatar_Reconstruction_From_Videos_in_the_Wild_via_CVPR_2023_paper.pdf), _[Project Page](https://moygcc.github.io/vid2avatar/)_, _[Code](https://github.com/MoyGcc/vid2avatar)_


[Fast-SNARF: A Fast Deformer for Articulated Neural Fields, IEEE Transactions on Pattern Analysis and Machine Intelligence](https://arxiv.org/pdf/2211.15601.pdf), _[Code](https://github.com/xuchen-ethz/fast-snarf)_

[PoseVocab: Learning Joint-structured Pose Embeddings for Human Avatar Modeling, SIGGRAPH](https://arxiv.org/pdf/2304.13006.pdf), _[ProjectPage](https://lizhe00.github.io/projects/posevocab/)_, _[Code](https://github.com/lizhe00/PoseVocab)_

[DNA: Deformable Neural Articulations Network for Template-free Dynamic 3D Human Reconstruction from Monocular RGB-D Video, CVPR](https://openaccess.thecvf.com/content/CVPR2023W/Precognition/papers/Vo_DNA_Deformable_Neural_Articulations_Network_for_Template-Free_Dynamic_3D_Human_CVPRW_2023_paper.pdf)

[PersonNeRF: Personalized Reconstruction from Photo Collections, CVPR](https://openaccess.thecvf.com/content/CVPR2023/papers/Weng_PersonNeRF_Personalized_Reconstruction_From_Photo_Collections_CVPR_2023_paper.pdf), _[Project Page](https://grail.cs.washington.edu/projects/personnerf/)_, 

[UVA: Towards Unified Volumetric Avatar for View Synthesis, Pose rendering, Geometry and Texture Editing](https://arxiv.org/pdf/2304.06969v1.pdf)


[SHERF: Generalizable Human NeRF from a Single Image, ICCV](https://arxiv.org/pdf/2303.12791.pdf), _[Project Page](https://skhu101.github.io/SHERF/)_, _[Code](https://github.com/skhu101/SHERF)_
...
[ICON: Implicit Clothed Humans Obtained from Normals, CVPR](https://arxiv.org/pdf/2112.09127.pdf), _[Project Page](https://icon.is.tue.mpg.de/)_, _[Code](https://github.com/YuliangXiu/ICON)_

[gDNA: Towards Generative Detailed Neural Avatars, CVPR](https://openaccess.thecvf.com/content/CVPR2022/papers/Chen_gDNA_Towards_Generative_Detailed_Neural_Avatars_CVPR_2022_paper.pdf), _[Project Page](https://xuchen-ethz.github.io/gdna/)_, _[Code](https://github.com/xuchen-ethz/gdna)_

[AvatarCap: Animatable Avatar Conditioned Monocular Human Volumetric Capture, ECCV](https://arxiv.org/pdf/2207.02031.pdf), _[Project Page](https://liuyebin.com/avatarcap/avatarcap.html)_, _[Code](https://github.com/lizhe00/AvatarCap)_

[Animatable Implicit Neural Representations fro Creating Realistic Avatars from Videos, ](https://arxiv.org/pdf/2203.08133.pdf), _[Project Page](https://zju3dv.github.io/animatable_sdf/)_, _[Code](https://github.com/zju3dv/animatable_nerf)_


[AG3D: Learning to Generate 3D Avatars from 2D Image Collections, ICCV](https://arxiv.org/pdf/2305.02312.pdf), _[Project Page](https://zj-dong.github.io/AG3D/)_, _[Code](https://github.com/zj-dong/AG3D)_
...
[A-SDF: Learning Disentangled Signed Distance Functions for Articulated Shape Representations, ICCV](https://openaccess.thecvf.com/content/ICCV2021/papers/Mu_A-SDF_Learning_Disentangled_Signed_Distance_Functions_for_Articulated_Shape_Representation_ICCV_2021_paper.pdf), _[Project Page](https://jitengmu.github.io/A-SDF/)_, _[Code](https://github.com/JitengMu/A-SDF)_, (Not humans but still articulated)
...
### 2023
[StyleAvatar: Real-time Photo-realistic Portrait Avatar from a Single Video, SIGGRAPH](https://arxiv.org/pdf/2305.00942.pdf), _[Project Page](https://www.liuyebin.com/styleavatar/styleavatar.html)_, _[Code](https://github.com/LizhenWangT/StyleAvatar)_


[ECON: Explicit Clothed Humans Optimized via Normal Integration, CVPR](https://openaccess.thecvf.com/content/CVPR2023/papers/Xiu_ECON_Explicit_Clothed_Humans_Optimized_via_Normal_Integration_CVPR_2023_paper.pdf), _[Project Page](https://econ.is.tue.mpg.de/)_, _[Code](https://github.com/YuliangXiu/ECON)_


[3D Generative Model Latent Disentanglement via Local Eigenprojection, Computer Graphics Forum](https://onlinelibrary.wiley.com/doi/pdf/10.1111/cgf.14793), _[Code](https://github.com/simofoti/LocalEigenprojDisentangled)_


[ASM: Adaptive Skinning Model for High-Quality 3D Face Modeling](https://arxiv.org/pdf/2304.09423.pdf), _[Unofficial Code](https://github.com/LiuLinyun/ASM-unofficial)_

### 2022
[REALY: Rethinking the Evaluation of 3D Face Reconstruction, ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/papers/136680072.pdf), _[Project Page](https://realy3dface.com/)_, _[Code](https://github.com/czh-98/REALY)_

[Neural Point-based Shape Modeling of Humans in Challenging Clothing, 3DV](https://arxiv.org/pdf/2209.06814.pdf), _[Project Page](https://qianlim.github.io/SkiRT)_, _[Code](https://github.com/qianlim/SkiRT)_
...
[NeRO: Neural Geometry and BRDF Reconstruction of Reflective Objects from Multiview Images, SIGGRAPH](https://arxiv.org/pdf/2305.17398.pdf), _[Code](https://github.com/liuyuan-pal/NeRO)_

[Explicit Neural Surfaces: Learning Continuous Geometry with Deformation Fields, NeurIPS](https://arxiv.org/pdf/2306.02956.pdf), 
...
[Deep Marching Tetrahedra: a Hybrid Representation for High-Resolution 3D Shape Synthesis, NeurIPS](https://arxiv.org/pdf/2111.04276.pdf), _[Project Page](https://nv-tlabs.github.io/DMTet/)_, _[Code](https://github.com/NVIDIAGameWorks/kaolin)_


[NeRFactor: Neural Factorization of Shape and Reflectance Under an Unknown Illumination, SIGGRAPH](https://arxiv.org/pdf/2106.01970.pdf), _[Project Page](https://xiuming.info/projects/nerfactor/)_, _[Code](https://github.com/google/nerfactor)_
...
### 2021
[Appearance-Driven Automatic 3D Model Simplification, SIGGRAPH](https://arxiv.org/pdf/2104.03989.pdf), _[Project Page](https://research.nvidia.com/publication/2021-04_appearance-driven-automatic-3d-model-simplification)_, _[Code](https://github.com/NVlabs/nvdiffmodeling)_
### 2020
[Modular Primitives for High-Performance Differentiable Rendering, SIGGRAPH](https://arxiv.org/pdf/2011.03277.pdf), _[Code](https://github.com/NVlabs/nvdiffrast)_

## Learning 3D from images
### 2023
[Fantasia3D: Disentangling Geometry and Appearance for High-quality Text-to-3D Content Creation](https://arxiv.org/pdf/2303.13873.pdf), _[Project Page](https://fantasia3d.github.io/)_, _[Code](https://github.com/Gorilla-Lab-SCUT/Fantasia3D)_
